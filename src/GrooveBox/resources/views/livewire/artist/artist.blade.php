<div>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-12">
            <img class="rounded-circle" src="{{asset('storage/'.$this->artist->image)}}" width="100%"/>
        </div>
        @if(auth()->check())
            @if(auth()->user()->hasArtist() && $this->artist->id == auth()->user()->artist->id)
                <div class="col-md-6 col-sm-12">
                    <h1 class="fs-1">{{$this->artist->artist_name}}</h1>
                </div>
                <div class="col-3 d-flex justify-content-end">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item text-light" href="/update-artist">Update Profile</a></li>
                        </ul>
                    </div>
                </div>
            @else
